...
### Features
- Responds to greetings like "hello", "how are you"
- Displays current time
- Shows message count
- Help command for available inputs
- Exit using "bye"
### How to Run
...
- Displays hidden word using underscores
- Allows user to guess one letter at a time
- Tracks incorrect guesses (max 6 attempts)
- Prevents repeated letter guessing
...
- Tracks total portfolio investment
- Handles invalid stock input
- Stores complete portfolio data in CSV format
- Displays final total investment summary
### How to Run
